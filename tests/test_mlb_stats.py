...
from fairline.mlb_stats import _aggregate_batter_games, _derive_starters

# One game (game_pk=1), Yankees at home vs Red Sox. Judge goes 2-for-4 with a
# home run (3 total bases from the HR + 1 from the single = 6 total bases),
# 1 strikeout, faces starter Brayan Bello the whole game.
